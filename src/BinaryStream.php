...
class BinaryStream{
	 ...
	 * @param int|string int, or the string representation of an int64 on 32-bit platforms $v
	 */
	 ...
	 * @param int|string int, or the string representation of an int64 on 32-bit platforms
	 */
